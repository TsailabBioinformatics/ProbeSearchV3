...
const razers3Aligner = require('/home/tsai-apps/ProbeSearchV3.2/razers3'); // The path should be relative to your main file
const _717V2 = require('/home/tsai-apps/ProbeSearchV3.2/717V2'); // The path should be relative to your main file
const fs = require('fs');
...
const serverLogFile = path.join("/home/tsai-apps/ProbeSearchV3.2/", 'usageV3.2.log');
...
app.put('/',  async (req, res) => {
    ...
    if (req.body.read.length > 50) {
		...
		if(aligner=="bowtie2"){
			...
			razers3Aligner.rAligner(input, db, X, maxHit, gapFlag)
			.then(stdout => {
				res.send(stdout);
