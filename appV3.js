...
const razers3Aligner = require('/home/tsai-apps/ProbeSearchV3.2/razers3V3'); // The path should be relative to your main file
...
app.listen({ port: 8503 }, async () => {
    console.log('server up @ http://localhost:8503/ !')
});
